 ...
 *
 */
public class CLI_UserInterface implements UserInterface
{
	/**
	 * Initializes variables.
	 */
	public CLI_UserInterface()
	{
	...
	private class SingleOptionDisplay implements ExtraImplementation
	{
		 ...
		 * 		a wrapper for.
		 */
		public SingleOptionDisplay(CLI_UserInterface ui,
	...
	private class FieldDisplay implements ExtraImplementation
	{
		 ...
		 * 		wrapper for.
		 */
		public FieldDisplay(CLI_UserInterface ui, FieldContainer fc)
		{
			this.ui = ui;
			this.fc = fc;
			entry = null;
